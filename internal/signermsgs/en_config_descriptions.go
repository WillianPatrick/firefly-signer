...
var (
	...
	ConfigAWSKMSEnabled                          = ffc("config.awsKMS.enabled", "Whether the AWS KMS is enabled", "boolean")
	ConfigAWSKMSRegion                           = ffc("config.awsKMS.region", "The AWS region where the KMS keys are located", "string")
	ConfigAWSKMSAccessKeyID                      = ffc("config.awsKMS.accessKeyID", "The AWS Access Key ID for authentication", "string")
	ConfigAWSKMSSecretAccessKey                  = ffc("config.awsKMS.secretAccessKey", "The AWS Secret Access Key for authentication", "string")
	ConfigAWSKMSRemoteSign                       = ffc("config.awsKMS.remoteSign", "Enable or disable remote sign transactions", "boolean")
